    ...
    >
      ...
      <div className="relative mx-auto max-w-4xl text-center">
        ...
        <div className="mt-12 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
          <a
            href="#viewer"
            className="inline-flex items-center gap-2.5 rounded-full px-8 py-4 text-[15px] font-bold text-white shadow-lg shadow-blue-500/20 transition-all hover:shadow-xl hover:shadow-blue-500/30 sm:text-base"
